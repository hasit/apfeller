...
assert_contains "$list_output" 'oneliner' "catalog listing should include oneliner"
...
assert_contains "$install_output" 'Installed oneliner 0.1.0' "install should report oneliner success"
...
assert_contains "$installed_output" 'oneliner' "installed listing should include oneliner"
...
assert_contains "$update_output" 'Installed oneliner 0.1.0' "update --all should reinstall the second ai-command app"
