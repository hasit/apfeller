...
assert_not_contains "$readme" '## Local Utility' "README should not mention a non-AI utility section anymore"
...
assert_not_contains "$readme" '`port`' "README should not mention port anymore"
...
assert_not_contains "$home_page" '## Local Utility' "home page should not have a local utility section anymore"
