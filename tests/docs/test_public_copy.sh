...
assert_contains "$catalog_page" 'Click any app row' "catalog page should explain that rows expand for more detail"
...
assert_contains "$catalog_js" 'aria-expanded' "catalog script should render accessible expandable controls"
assert_contains "$catalog_js" 'catalog-table' "catalog script should render the catalog as a table"
assert_contains "$catalog_js" 'catalog-detail-row' "catalog script should render expanded details in a dedicated detail row"
assert_contains "$catalog_js" 'TABLE_COLUMN_COUNT' "catalog script should track the table column count for expanded details"
assert_contains "$catalog_js" 'renderDetailRowMarkup' "catalog script should build expanded details as a dedicated table row"
assert_contains "$catalog_js" 'stopPropagation' "catalog script should keep source-link clicks from toggling rows"
